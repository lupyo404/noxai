...
const App: React.FC = () => {
  const [apiKey, setApiKey] = useState<string | null>(() => import.meta.env.VITE_GEMINI_API_KEY || null);
    ...
    return (
      <>
        ...
        <div className="fixed bottom-6 right-6 z-30 flex flex-col items-end gap-4">
            {isLiveChatOpen && <LiveChatWidget apiKey={apiKey!} onClose={() => setIsLiveChatOpen(false)} />}
            <button
