  ...
  return (
    <div className="relative w-full max-w-2xl bg-slate-800/70 backdrop-blur-md p-8 rounded-xl shadow-2xl border border-slate-200/50 text-center">
        ...
        <div className="mt-8 p-4 bg-yellow-900/30 border border-yellow-500/50 rounded-lg text-left text-sm text-yellow-200">
           ...
           <p className="mt-2">
            On a production or shared environment like Vercel, it is <strong className="font-semibold">strongly recommended</strong> to set the API key using the <code>VITE_GEMINI_API_KEY</code> environment variable.
           </p>
            <p className="mt-1">
                The key you enter here is used for the current session only. It will be cleared when you refresh or close the page.
           </p>
        </div>
    </div>
  );
